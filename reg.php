    ...
    <div class="container">
        <div class="d-flex align-items-center justify-content-center">
            <div class="music__box-lk__wrap">
                <div class="music__box-lk__title">Регистрация</div>
                <div class="music__box-lk__wrap__row">
                    <div class="music__box-lk__col-left">
                        <form action="" class="music__form">
                            ...
                            <div class="music__form__box-inp">
                                <input type="submit" class="music__form__submit" value="ЗАРЕГИСТРИРОВАТЬСЯ">
                            </div>
                            <div class="text-center">
                                <a href="" class="music__link-border">Я уже зарегистрирован</a>
                            </div>
                        </form>
                    </div>
