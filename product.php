        ...
        <div class="col-12 music__page music__produc">
            <div class="music__page__breadcrumbs">
                <ul class="nav">
                    ...
                    <li><span>Виниловый проигрыватель Lenco L-3808 Matt Grey</span></li>
                </ul>
            </div>
            <div class="music__produc__title-mob">
                Виниловый проигрыватель
                Lenco L-3808 Matt Grey
            </div>
            <div class="row music__product__img-row">
                ...
                <div class="col-lg-5">
                    ...
                    <div class="music__product__rev-top">
                        <div class="music__product__col-res-rev">
...
<div class="container">
    <div class="music__section music__section--border">
        ...
        <div class="music__slider-set">
            <div class="swiper-container" id="setSlider">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="row align-items-center">
                            <div class="col-lg-4 music__slider-set__item">
                                ...
                                <div class="music__slider-set__item__action">+</div>
                            </div>
                            <div class="col-lg-4 music__slider-set__item">
                                <div class="music__carusel-product__item music__item-product">
                                    <a href="" class="music__item-product__link">
                            ...
                            <div class="col-lg-4 ">
                                <div class="music__slider-set__itog">
                                    ...
                                    <div class="music__slider-set__itog__bay">
                                        <button class="btn-bay w-auto">
                                            <span>ДОБАВИТЬ КОМПЛЕКТ В КОРЗИНУ</span>
                                        </button>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="music__section">
        <h2 class="music__caption">С этим товаром покупают</h2>
        <?php
