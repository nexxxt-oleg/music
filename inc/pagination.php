<div class="music__page__pagination">
    <div class="music__page__pagination__more-page">
    ...
    <nav class="music__page__pagination__nav">
        <ul class="nav justify-content-center align-items-center">
            ...
            <li><a href="" class="music__page__pagination__nav__page">1</a></li>
            <li><span class="music__page__pagination__nav__page is_active">2</span></li>
            <li><a href="" class="music__page__pagination__nav__page">3</a></li>
            <li><a href="" class="music__page__pagination__nav__page">4</a></li>
