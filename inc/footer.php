        ...
        <div class="row fpad30 ">
            <div class="col-lg-4 col-xl-4 fpad30 music__footer__nav-box">
                <ul class="nav flex-column music__footer__nav">
                    ...
                    <li><a href=""><b>Аксессуары</b></a></li>
                    <li><a href=""><b>Системы хранения пластинок</b></a></li>
                    <li><a href=""><b>Подобрать проигрыватель</b></a></li>
                    <li><a href=""><b>Бренды</b></a></li>
                        ...
                        <a href="" target="_blank">
                            ...
                            <svg width="24" height="24" xmlns="http://www.w3.org/2000/svg"
                                ...
                                <defs>
                                    ...
                                    <linearGradient id="soc" x1="42.97" y1="44.97" x2="469.03"
                                                    y2="471.04" gradientTransform="matrix(1, 0, 0, -1, 0, 514)"
                                                    gradientUnits="userSpaceOnUse">
                                        <stop offset="0" stop-color="#ffd600"/>
                                        <stop offset="0.5" stop-color="#ff0100"/>
                                        <stop offset="1" stop-color="#d800b9"/>
                                    </linearGradient>
                                    <linearGradient id="soc_2" x1="163.04" y1="165.05" x2="348.95"
                                                    y2="350.96" gradientTransform="matrix(1, 0, 0, -1, 0, 514)"
                                                    gradientUnits="userSpaceOnUse">
                                        <stop offset="0" stop-color="#ff6400"/>
                                        <stop offset="0.5" stop-color="#ff0100"/>
                                        <stop offset="1" stop-color="#fd0056"/>
                                    </linearGradient>
                                    <linearGradient id="soc_3" x1="370.93" y1="372.93" x2="414.37"
                                                    y2="416.38" gradientTransform="matrix(1, 0, 0, -1, 0, 514)"
                                                    gradientUnits="userSpaceOnUse">
                    ...
                    <li>
                        <a href="" target="_blank">
                            <svg width="11" height="24" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 33.75 73.2">
                                <path fill="#4066b6"
                                      d="M32.39,36.53h-10V73.2H7.21V36.53H0V23.64H7.21V15.3c0-6,2.84-15.3,15.3-15.3L33.75.05V12.56H25.6c-1.34,0-3.22.67-3.22,3.51v7.59H33.71Z"/>
                            </svg>
                        </a>
                    </li>
                    <li>
