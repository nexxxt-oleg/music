<div class="voessen__item-product voessen__item-product--mob-col">
    <div class="row row--min">
        ...
        <div class="voessen__item-product__col-right col-lg-12 col-6">
    ...
    <div class="row row--min">
        <div class="col-6 col-lg-6 voessen__item-product__col-count">
        ...
        <div class="col-3 col-lg-6 col-sm-6 voessen__item-product__btn-bay">
