...
$( document ).ready(function() {
    /**
     * https://www.jqueryscript.net/form/jQuery-AJAX-File-Uploader-FileUp.html
     */
    ...
    if($('#upload-demo2').length > 0) {
        $.fileup({
            //url: 'upload.php',
            inputID: 'upload-demo2',
            queueID: 'upload-demo-queue2',
            dropzoneID: 'upload-dropzone2',
            autostart: true,
            lang: 'ru',
            onSuccess: function (response, file_number, file) {
                // do something
